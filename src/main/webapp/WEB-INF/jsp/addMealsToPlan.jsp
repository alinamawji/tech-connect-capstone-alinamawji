...
<h1 class="display-5">Schedule Meals in your Plan</h1>
<hr>
...
<div class="container">
    ...
    <div id="planned_meal">
        <div class="form-group">
            <label class="display-5">Select which meal you'd like to add: </label>
        ...
        <div class="form-group">
            <label class="display-5">Select which day you're planning meals for: </label>
        ...
        <div class="form-group">
            <label class="display-5">Select what time of day you'd like for this meal:</label>
        ...
        <div class="form-group">
            <p>Continue scheduling your meals or finish your meal plan by clicking submit.</p>
            <input class="btn btn-success btn-sm" type="submit" id="submitMeal" name="submitMeal"
                   value="Add Planned Meal">
        </div>
    </div>
    </form:form>
